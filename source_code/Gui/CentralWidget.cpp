...
//  home_show = new QAction(tr("Show &Home Tab"), this);
//  connect(home_show, &QAction::triggered, this, &GuiCentralWidget::switchTabBlock);

//  chat_show = new QAction(tr("Show &Chat Tab"), this);
//  connect(chat_show, &QAction::triggered, this, &GuiCentralWidget::switchTabBlock);
...
void GuiCentralWidget::switchTabBlock()
{
  if(sender() == home_show)
    {
      gui_tab_block->switchTab(1);
    }
  else if(sender() == chat_show)
    {
      gui_tab_block->switchTab(2);
    }
  else if(sender() == settigns_show)
    {
      gui_tab_block->switchTab(3);
    }
}
